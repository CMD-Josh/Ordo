 ...
 *
 ****************************************************************************/
package org.ordo.project.model.test;
...
public class ModelJaxbTest {
    ...
    public void testJaxb() {
        ...
        try {
            ...
            JAXBContext jaxbContext = JAXBContext.newInstance("org.ordo.project.model");
            ...
            for (int intityId = 0; intityId < 3; intityId++) {
                ...
                entity.setTimeStart("field_A_" + intityId);
                entity.setTimeEnd("field_B_" + intityId);;
                entity.setPrice("field_C_" + intityId);;
                entities.add(entity);
            }
